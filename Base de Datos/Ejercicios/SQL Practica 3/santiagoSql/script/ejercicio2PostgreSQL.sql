...
-- Name: ejercicio2anio2017; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA ejercicio2anio2017;


ALTER SCHEMA ejercicio2anio2017 OWNER TO postgres;

SET search_path = ejercicio2anio2017, pg_catalog;
...
-- Dependencies: 5
-- Name: club; Type: TABLE; Schema: ejercicio2anio2017; Owner: postgres; Tablespace: 
--
...
ALTER TABLE ejercicio2anio2017.club OWNER TO postgres;

--
-- TOC entry 1499 (class 1259 OID 43234)
-- Dependencies: 5
-- Name: competencia; Type: TABLE; Schema: ejercicio2anio2017; Owner: postgres; Tablespace: 
--
...
ALTER TABLE ejercicio2anio2017.competencia OWNER TO postgres;

--
-- TOC entry 1500 (class 1259 OID 43237)
-- Dependencies: 5
-- Name: participacion; Type: TABLE; Schema: ejercicio2anio2017; Owner: postgres; Tablespace: 
--
...
ALTER TABLE ejercicio2anio2017.participacion OWNER TO postgres;

--
-- TOC entry 1778 (class 0 OID 43231)
-- Dependencies: 1498
-- Data for Name: club; Type: TABLE DATA; Schema: ejercicio2anio2017; Owner: postgres
--
...
-- Dependencies: 1499
-- Data for Name: competencia; Type: TABLE DATA; Schema: ejercicio2anio2017; Owner: postgres
--
...
-- Dependencies: 1500
-- Data for Name: participacion; Type: TABLE DATA; Schema: ejercicio2anio2017; Owner: postgres
--
