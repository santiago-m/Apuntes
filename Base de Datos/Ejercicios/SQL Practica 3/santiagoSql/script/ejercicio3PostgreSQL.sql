DROP schema IF EXISTS ejercicio3anio2017 cascade;
CREATE schema ejercicio3anio2017;

DROP TABLE IF EXISTS ejercicio3anio2017.alumno;
CREATE TABLE ejercicio3anio2017.alumno (
...
DROP TABLE IF EXISTS ejercicio3anio2017.taller;
CREATE TABLE ejercicio3anio2017.taller (
...
DROP TABLE IF EXISTS ejercicio3anio2017.realiza;
CREATE TABLE ejercicio3anio2017.realiza (
  nro_alumno integer NOT NULL ,
  codigo_taller integer NOT NULL ,
  PRIMARY KEY (nro_alumno,codigo_taller),
  constraint fk_realiza_nro_alumno
    foreign key (nro_alumno)
    REFERENCES ejercicio3anio2017.alumno (nro_alumno),
  constraint fk_realiza_codigo_taller
    foreign key (codigo_taller) 
    REFERENCES ejercicio3anio2017.taller 
);

INSERT INTO ejercicio3anio2017.alumno VALUES
...
INSERT INTO ejercicio3anio2017.taller VALUES
 (1, 'Cocina', 28),
...
INSERT INTO ejercicio3anio2017.realiza VALUES
 (1,1),
 (1,2),
 (1,5),
 (2,2),
