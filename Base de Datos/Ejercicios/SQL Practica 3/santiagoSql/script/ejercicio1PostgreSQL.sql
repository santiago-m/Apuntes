drop schema if exists ejercicio1anio2017 cascade;
CREATE schema ejercicio1anio2017;



DROP TABLE IF EXISTS  ejercicio1anio2017.producto ;
CREATE TABLE  ejercicio1anio2017.producto  (
...
INSERT INTO  ejercicio1anio2017.producto  ( COD_PRODUCTO , DESCRIPCION , PRECIO ) VALUES 
...
CREATE TABLE ejercicio1anio2017.cliente (
...
INSERT INTO  ejercicio1anio2017.cliente  ( NRO_CLIENTE , APELLIDO , NOMBRE , DIRECCION , TELEFONO ) VALUES
...
DROP TABLE IF EXISTS  ejercicio1anio2017.factura ;
CREATE TABLE  ejercicio1anio2017.factura  (
   NRO_FACTURA  varchar(12) NOT NULL,
   FECHA  date NOT NULL,
   NRO_CLIENTE  int NOT NULL,
   MONTO  decimal(9,2) default NULL,
  PRIMARY KEY  ( NRO_FACTURA ),
  CONSTRAINT  FK_FACTURA_1  FOREIGN KEY ( NRO_CLIENTE ) REFERENCES  ejercicio1anio2017.cliente  ( NRO_CLIENTE )
); 
...
INSERT INTO  ejercicio1anio2017.factura  ( NRO_FACTURA , FECHA , NRO_CLIENTE , MONTO ) VALUES 
...
DROP TABLE IF EXISTS  ejercicio1anio2017.itemfactura ;
CREATE TABLE  ejercicio1anio2017.itemfactura  (
   NRO_FACTURA  varchar(12) NOT NULL,
   COD_PRODUCTO  int NOT NULL,
   CANTIDAD  int NOT NULL,
   PRECIO  decimal(9,2) NOT NULL,
  PRIMARY KEY  ( NRO_FACTURA , COD_PRODUCTO ),
  CONSTRAINT  FK_ITEMFACTURA_1  FOREIGN KEY ( COD_PRODUCTO ) REFERENCES  ejercicio1anio2017.producto  ( COD_PRODUCTO ),
  CONSTRAINT  FK_ITEMFACTURA_2  FOREIGN KEY ( NRO_FACTURA ) REFERENCES  ejercicio1anio2017.factura  ( NRO_FACTURA )
);
...
INSERT INTO  ejercicio1anio2017.itemfactura  ( NRO_FACTURA , COD_PRODUCTO , CANTIDAD , PRECIO ) VALUES 
